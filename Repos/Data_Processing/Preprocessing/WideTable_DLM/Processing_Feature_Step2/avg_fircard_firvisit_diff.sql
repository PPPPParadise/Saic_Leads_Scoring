...
DROP TABLE IF EXISTS marketing_modeling.tmp_dlm_avg_fircard_firvisit_diff;
CREATE TABLE marketing_modeling.tmp_dlm_avg_fircard_firvisit_diff as  
SELECT
	a1.mobile,
...
(
	...
	(
		...
		FROM
			marketing_modeling.tmp_dlm_hall_flow_cleansing2  --到店
	...
	(
		...
		FROM 
			marketing_modeling.tmp_dlm_cust_cleansing  -- 建卡
