...
DROP TABLE IF EXISTS marketing_modeling.tmp_dlm_firfollow_dealf_diff;

CREATE TABLE marketing_modeling.tmp_dlm_firfollow_dealf_diff as 
SELECT 
	a1.mobile,
...
(
	...
	FROM
		marketing_modeling.tmp_dlm_followup_processing a,
