...
DROP TABLE IF EXISTS marketing_modeling.tmp_dlm_receive_processing;
CREATE TABLE marketing_modeling.tmp_dlm_receive_processing as  
SELECT
    a.mobile,
...
FROM
	(
		...
		FROM
			marketing_modeling.tmp_dlm_trial_receive_cleansing2 
		WHERE rn2 = 1
	) a 
	left join 
	(
