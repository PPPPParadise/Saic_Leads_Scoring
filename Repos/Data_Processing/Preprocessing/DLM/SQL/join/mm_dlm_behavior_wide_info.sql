...
CREATE TABLE marketing_modeling.mm_dlm_behavior_wide_info as 
SELECT 
	a1.*,
...
FROM
	marketing_modeling.dlm_tmp_feature_join_1 a1
left join 
	marketing_modeling.dlm_tmp_feature_join_2 a2 on a1.mobile = a2.mobile 
left join 
	marketing_modeling.dlm_tmp_feature_join_3 a3 on a1.mobile = a3.mobile
left join 
	marketing_modeling.dlm_tmp_feature_join_4 a4 on a1.mobile = a4.mobile
;