...
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_followup_processing;
CREATE TABLE marketing_modeling.dlm_tmp_followup_processing as  
SELECT
    a.mobile,
	a.first_time,    -- 首次跟进时间
...
FROM
	(
		...
		FROM
			marketing_modeling.dlm_tmp_followup_cleansing2 
		WHERE rn2 = 1
	) a 
	left join 
	(
