...
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_trial_receive_cleansing;
CREATE TABLE marketing_modeling.dlm_tmp_trial_receive_cleansing as
SELECT 
...
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_trial_receive_cleansing2;
CREATE TABLE marketing_modeling.dlm_tmp_trial_receive_cleansing2 as
select 
	a.*,
