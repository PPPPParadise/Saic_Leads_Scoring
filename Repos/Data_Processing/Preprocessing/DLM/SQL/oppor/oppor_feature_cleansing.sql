...
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_oppor_cleansing;
CREATE TABLE marketing_modeling.dlm_tmp_oppor_cleansing as
SELECT 
	a.cust_id,
	b.mobile,
	a.dealer_id,
...
FROM 
	(
		...
		WHERE o.vel_series_id = c.series_dol_product_id
		  AND o.create_time >= '2019-08-01 00:00:00' 
