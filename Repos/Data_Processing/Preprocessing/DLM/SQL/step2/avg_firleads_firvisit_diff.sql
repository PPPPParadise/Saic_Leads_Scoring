...
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_avg_firleads_firvisit_diff;
CREATE TABLE marketing_modeling.dlm_tmp_avg_firleads_firvisit_diff as  
SELECT
	a1.mobile,
...
(
	...
	(
		...
		FROM 
			marketing_modeling.dlm_tmp_leads_cleansing 
