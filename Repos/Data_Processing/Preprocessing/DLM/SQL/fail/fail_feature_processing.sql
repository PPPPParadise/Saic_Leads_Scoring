...
--失败数据统计
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_fail_processing;
CREATE TABLE marketing_modeling.dlm_tmp_fail_processing as  
SELECT
    a.mobile,
...
FROM
	(
		...
		FROM
			marketing_modeling.dlm_tmp_fail_cleansing2 
		where rn2 = 1 
	) a 
	left join 
	(
