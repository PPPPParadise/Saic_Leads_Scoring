...
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_fail_cleansing;
CREATE TABLE marketing_modeling.dlm_tmp_fail_cleansing as
select 
	a.cust_id,
	b.mobile,
	a.dealer_id,
...
;
-- 按mobile再分组计算出首次战败时间 
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_fail_cleansing2;
CREATE TABLE marketing_modeling.dlm_tmp_fail_cleansing2 as
select 
	a.*,
...
from 
	marketing_modeling.dlm_tmp_fail_cleansing a
;