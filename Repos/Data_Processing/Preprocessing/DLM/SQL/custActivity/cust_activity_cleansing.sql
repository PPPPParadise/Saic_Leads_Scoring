...
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_cust_activity_cleansing;
CREATE TABLE marketing_modeling.dlm_tmp_cust_activity_cleansing as
SELECT 
	a.cust_id,
	b.mobile,
	a.dealer_id,
...
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_cust_activity_cleansing2;
CREATE TABLE marketing_modeling.dlm_tmp_cust_activity_cleansing2 as
select 
	a.*,
