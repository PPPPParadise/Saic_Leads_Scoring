...
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_last_activity_dealf_diff;

CREATE TABLE marketing_modeling.dlm_tmp_last_activity_dealf_diff as 
SELECT 
	a1.mobile,
...
(
	...
	FROM
		marketing_modeling.dlm_tmp_cust_activity_processing a,
