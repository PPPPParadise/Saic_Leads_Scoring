...
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_task_item_cleansing_2;
CREATE TABLE marketing_modeling.dlm_tmp_task_item_cleansing_2 as 
SELECT 
	a.task_id,
    a.cust_id,
    a.mobile,
...
FROM
	marketing_modeling.dlm_tmp_task_item_cleansing_1 a,
	marketing_modeling.voip_call_record b
