...
DROP TABLE IF EXISTS marketing_modeling.dlm_tmp_task_item_cleansing_1;
CREATE TABLE marketing_modeling.dlm_tmp_task_item_cleansing_1 as 
with tk as (
    select id 
...
t1 as (
   select id,
    ...
    where pt='${pt}' and call_id is not null and created_time >= '2019-01-01 00:00:00'
),
t2 as (
    select id,
		task_id,
