...
echo "---------------------step2/GIO_deal_flag_map.sql start......"
hive -f $SQL_PATH/GIO_deal_flag_map.sql >& $LOG_DIR/GIO_deal_flag_map.log
echo "---------------------step2/GIO_deal_flag_map.sql end ......"
echo "---------------------step2/GIO_action_map.sql start......"
hive -f $SQL_PATH/GIO_action_map.sql >& $LOG_DIR/GIO_action_map.log
echo "---------------------step2/GIO_action_map.sql end ......"
echo "---------------------step2/GIO_activity_map.sql start......"
hive -f $SQL_PATH/GIO_activity_map.sql >& $LOG_DIR/GIO_activity_map.log
echo "---------------------step2/GIO_activity_map.sql end ......"
